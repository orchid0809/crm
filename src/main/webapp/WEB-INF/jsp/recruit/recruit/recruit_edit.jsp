	...
	<script type="text/javascript" src="static/js/jquery.tips.js"></script>
		...
		$('.add_recruit').click(function(){
				...
				var recruit_str='<tr class="recruit_Info">'
					+'<td><input type="text" class="position" name="recruits['+cnt+'].recruitPosition" value="${pd.ENTERPRISE_ADDRESS}" maxlength="100" placeholder="这里输入招聘职位" title="招聘职位" style="width:98%;"/></td>'
						+'<td><input type="text" class="cnt" name="recruits['+cnt+'].recruitCnt" value="${pd.ENTERPRISE_ADDRESS}" maxlength="100" placeholder="这里输入招聘人数" title="招聘人数" style="width:98%;"/></td>'
						+'<td><input type="text" class="require" name="recruits['+cnt+'].positionRequire" value="${pd.ENTERPRISE_ADDRESS}" maxlength="100" placeholder="这里输入职位要求" title="职位要求" style="width:98%;"/></td>'
						+'<td>'
						+'<i class=" remove_recruit ace-icon fa fa-trash-o bigger-120" title="删除"></i>'
						+'</td>'
						+'</tr>';
