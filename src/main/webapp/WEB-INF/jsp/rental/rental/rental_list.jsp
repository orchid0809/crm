					...
					<div class="row">
						...
						<table style="margin-top:5px;">
							<tr>
								...
								<td style="padding-left:2px;"><input class="deadLineTime date-picker" name="deadLineTime" name="lastEnd"  value="${pd.deadLineTime}" type="text" data-date-format="yyyy-mm-dd" readonly="readonly" style="width:88px;" placeholder="截至时间" title="结束日期"/></td>
										...
										<tr>
											...
											<td class="center">
												...
												<div class="hidden-sm hidden-xs btn-group">
													...
													<a class="btn btn-xs btn-primary" onclick="del('${var.RENTAL_ID}');">
